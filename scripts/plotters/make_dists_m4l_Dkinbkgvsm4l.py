...
outfile_name = "test14_mass4l_vtxFSR_BS_dists_DataAndZZ_70m4l870GeV_2P2F_Data.pdf"
...
for fs in list(finalstate_dct.keys())[:2]:
    integ_ls = []
    for b_str in relmassErr_bin_ls:
        ...
        h = rbe.make_hist(tree=t, branch="mass4l_vtxFSR_BS", branch_plotinfo_dct=branch_plotinfo_dct, per_event_weight="is2P2F * !isMCzz * weightwithFRratios", control_reg="2P2F",    show_stats=False, printer=printer, outpath_pdf=outpath_pdf)  #70, 870, 40 bins
        h = rbe.make_hist(tree=t, branch="mass4l_vtxFSR_BS", branch_plotinfo_dct=branch_plotinfo_dct, per_event_weight="is3P1F * !isMCzz * weightwithFRratios", control_reg="3P1F",    show_stats=False, printer=printer, outpath_pdf=outpath_pdf)  #70, 870, 40 bins
        h = rbe.make_hist(tree=t, branch="mass4l_vtxFSR_BS", branch_plotinfo_dct=branch_plotinfo_dct, per_event_weight="is3P1F * isMCzz * weightwithFRratios",  control_reg="3P1F_ZZ", show_stats=False, printer=printer, outpath_pdf=outpath_pdf)  #70, 870, 40 bins
        ...
        h = rbe.make_hist(tree=t, branch="mass4l_vtxFSR_BS", branch_plotinfo_dct=branch_plotinfo_dct, per_event_weight=evt_weight_4P0F,  control_reg="4P0F",    show_stats=False, printer=printer, outpath_pdf=outpath_pdf)  #70, 870, 40 bins
