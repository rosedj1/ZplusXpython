...
h1_data_2p2f_m4l = make_TH1F(internal_name="h1_data_2p2f_m4l", title="Data Raw: 2P2F", n_bins=40, xlabel=r"m_{4l}", x_min=70, x_max=870, ylabel=None, y_min=None, y_max=None, units="GeV")
h1_data_3p1f_m4l = make_TH1F(internal_name="h1_data_3p1f_m4l", title="Data Raw: 3P1F", n_bins=40, xlabel=r"m_{4l}", x_min=70, x_max=870, ylabel=None, y_min=None, y_max=None, units="GeV")
h1_data_2p2fpred_m4l = make_TH1F(internal_name="h1_data_2p2fpred_m4l", title="Data Prediction: 2P2F", n_bins=40, xlabel=r"m_{4l}", x_min=70, x_max=870, ylabel=None, y_min=None, y_max=None, units="GeV")
h1_data_3p1fpred_m4l = make_TH1F(internal_name="h1_data_3p1fpred_m4l", title="Data Prediction: 3P1F", n_bins=40, xlabel=r"m_{4l}", x_min=70, x_max=870, ylabel=None, y_min=None, y_max=None, units="GeV")
h1_data_2p2fin3p1f_m4l = make_TH1F(internal_name="h1_data_2p2fin3p1f_m4l", title="Data: 2P2F contribution to 3P1F", n_bins=40, xlabel=r"m_{4l}", x_min=70, x_max=870, ylabel=None, y_min=None, y_max=None, units="GeV")
