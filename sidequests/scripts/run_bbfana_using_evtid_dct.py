"""
------------------------------------------------------------------------------
PURPOSE: Prepares a template and uses the BBF Analyzer on root files specified by .
...
overwrite = 1
verbose = 1
infile_json = "../data/json/jakehas_butnotfilippo_data2018_3p1f_deleteme.json"
output_rootfile_basename = "jakehas_butnotfilippo_data2018_3p1f"
...
if __name__ == "__main__":
    ...
    # Grab all events.
    for evt_id in evt_id_rootfile_dct.keys():
    # evt_id = list(evt_id_rootfile_dct.keys())[index]
        ...
        # This txt file contains `cout` info from the BBF Analyzer!
        ...
        if verbose:
            replace_value("VERBOSE", "True", output_template)
