...
outfile = "/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/Samples/skim2L/Data/2018/fullstats/ZL_ZLL_4P_CR/noduplicates/Data2018_NoDuplicates_comparesetwithstrandtup.root"
overwrite = 0
...
for ct, evt in enumerate(t):
    if (ct % 10000) == 0:
        print(f"Event {ct}/{n_tot}. Duplicates found = {num_duplicates}")
